...
do_install () {
	mkdir -p ${D}${prefix}/lib/rustlib
	cp ${WORKDIR}/targets/${TARGET_ARCH}* ${D}${prefix}/lib/rustlib
}

rust_cross_sysroot_preprocess() {
    sysroot_stage_dir ${D}${prefix}/lib/rustlib ${SYSROOT_DESTDIR}${prefix}/lib/rustlib
}
